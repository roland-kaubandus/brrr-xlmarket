      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[32px] lg:gap-[48px]">
        ...
        <div className="flex flex-col gap-[24px]">
          ...
          <div className="border border-[#E8E8E8] p-[24px] sm:p-[28px]">
            ...
            <div className="flex flex-col gap-[10px] text-[14px] font-[family-name:var(--font-inter)]">
          ...
          <div className="flex flex-col gap-[12px]">
            <div className="flex items-start gap-[14px] p-[18px] border border-[#E8E8E8]">
              ...
              <div>
                ...
                <p className="text-[12px] text-[#999999] font-[family-name:var(--font-inter)] mt-[2px]">
            ...
            <div className="flex items-start gap-[14px] p-[18px] border border-[#E8E8E8]">
              ...
              <div>
                ...
                <Link
                  href="/tagastamine"
                  className="text-[12px] text-[#E8650A] hover:underline font-[family-name:var(--font-inter)] mt-[4px] inline-block"
                >
        ...
        <div className="border border-[#E8E8E8] p-[28px] sm:p-[36px] flex flex-col justify-between">
          <div>
            ...
            <p className="text-[14px] text-[#777777] font-[family-name:var(--font-inter)] leading-relaxed mb-[28px]">
