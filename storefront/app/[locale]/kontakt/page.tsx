...
import fallback from "@/lib/cms-fallback/contact.json"

export const metadata: Metadata = {
  title: "Contact — XLMARKET",
  description: "XLMARKET contact information. Reach out and we will respond within 1-2 business days.",
}

export default async function ContactPage({ params }: { params: Promise<{ locale: string }> }) {
  const locale = (await params).locale
  const page = (await getPlainPage("contact", locale)) ?? (fallback as unknown as typeof fallback)
