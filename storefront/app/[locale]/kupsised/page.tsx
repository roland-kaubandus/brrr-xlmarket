      ...
      <div className="max-w-[720px] text-[14px] font-[family-name:var(--font-jakarta)] text-[#555555] leading-relaxed space-y-[16px]">
          ...
          <table className="w-full text-left">
            ...
            <tbody>
              <tr className="border-t border-[#E8E8E8]">
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">xlmarket_cart_id</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">Ostukorvi hoidmine</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">Sessiooni lõpuni</td>
              </tr>
              <tr className="border-t border-[#E8E8E8]">
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">xlmarket_cookie_consent</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">Küpsiste nõusoleku meelespidamine</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">1 aasta</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="border border-[#E8E8E8] overflow-hidden">
          <table className="w-full text-left">
            ...
            <tbody>
              <tr className="border-t border-[#E8E8E8]">
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">_fbp</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">Meta Pixel — külastajate analüüs</td>
                <td className="px-[16px] py-[10px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#555555]">3 kuud</td>
              </tr>
            </tbody>
          </table>
        </div>
