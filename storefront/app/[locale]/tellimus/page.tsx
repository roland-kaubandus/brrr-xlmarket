...
export default function CheckoutPage() {
  ...
  if (loading) {
    return (
      <div className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[48px]">
        ...
        <p className="text-[#999999] font-[family-name:var(--font-jakarta)]">Laen andmeid...</p>
      </div>
    )
  }
    ...
    return (
      <div className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[48px]">
        ...
        <div className="flex flex-col items-center justify-center py-[64px] border border-[#E8E8E8] bg-[#FAFAFA]">
          <p className="text-[14px] font-[family-name:var(--font-jakarta)] text-[#999999] mb-[28px]">Sinu ostukorv on tühi.</p>
          <Link
            href="/"
    ...
    return (
      <div className="max-w-[720px] mx-auto px-[16px] sm:px-[24px] py-[48px]">
        <div className="flex flex-col items-center justify-center py-[64px] bg-white border border-[#E8E8E8]">
          ...
          <p className="text-[14px] font-[family-name:var(--font-jakarta)] text-[#555555] mb-[8px]">
            Täname ostu eest. Saadame kinnituse aadressile{" "}
            <strong>{form.email}</strong>.
          </p>
          {orderId && (
            <p className="text-[14px] font-[family-name:var(--font-jakarta)] text-[#555555] mb-[32px]">
  ...
  return (
    <div className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[32px] sm:py-[48px]">
      ...
      {error && (
        <div className="mb-[20px] px-[14px] py-[10px] bg-red-50 border border-red-200 text-red-700 text-[13px] font-[family-name:var(--font-jakarta)]" role="alert">
          {error}
        </div>
      )}
          ...
          <div className="lg:col-span-2 flex flex-col gap-[20px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-[16px]">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-[#E8E8E8] px-[12px] py-[9px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#333333] focus:outline-none focus:border-[#E8650A] transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full border border-[#E8E8E8] px-[12px] py-[9px] text-[13px] font-[family-name:var(--font-jakarta)] text-[#333333] bg-white focus:outline-none focus:border-[#E8650A] transition-colors"
                  >
            ...
            <div className="bg-white border border-[#E8E8E8] p-[20px]">
              ...
              {shippingOptions.length === 0 ? (
                <p className="text-[12px] text-[#999999] font-[family-name:var(--font-jakarta)]">Tarneviisid laaduvad...</p>
              ) : (
            ...
            <div className="bg-white border border-[#E8E8E8] p-[20px] sticky top-[80px]">
                ...
                {items.map((item) => (
                  <div key={item.id} className="flex gap-[12px]">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[12px] font-[family-name:var(--font-jakarta)] text-[#999999]">
              ...
              <div className="border-t border-[#E8E8E8] pt-[12px] flex flex-col gap-[8px]">
                <div className="flex justify-between">
                  <span className="text-[#999999] font-[family-name:var(--font-jakarta)]">Vahesumma</span>
                  <span>{formatPrice(cart.subtotal, cart.currency_code)}</span>
                </div>
                {cart.shipping_total > 0 && (
                  <div className="flex justify-between">
                    <span className="text-[#999999] font-[family-name:var(--font-jakarta)]">Tarne</span>
                    <span>{formatPrice(cart.shipping_total, cart.currency_code)}</span>
                  </div>
                )}
                {cart.tax_total > 0 && (
                  <div className="flex justify-between">
                    <span className="text-[#999999] font-[family-name:var(--font-jakarta)]">Käibemaks</span>
              ...
              <p className="text-[12px] font-[family-name:var(--font-jakarta)] text-[#999999] text-center mt-[10px]">
