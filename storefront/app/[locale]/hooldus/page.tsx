  ...
  return (
    <div>
      ...
      <section
        className="w-full"
        style={{
          background: "linear-gradient(135deg, #12121f 0%, #1a1a2e 60%, #12121f 100%)",
        }}
      >
      ...
      <section id="plans" className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[56px] sm:py-[72px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-[20px]">
          {PLANS.map(plan => (
            <div
              key={plan.slug}
              className={`relative border ${plan.popular ? "border-[#0ea5a0] bg-[#f0fdf9]" : "border-[#E2E8F0] bg-white"} p-[26px] flex flex-col`}
            >
              {plan.popular ? (
                <span className="absolute top-[-12px] left-[26px] bg-[#0ea5a0] text-white text-[10px] uppercase tracking-[0.12em] font-[700] px-[8px] py-[3px] font-[family-name:var(--font-dm-sans)]">
                  Most popular
                </span>
              ) : null}
              ...
              <div className="mb-[14px]">
                <div className="text-[32px] font-[800] text-[#1a1a2e] leading-none tabular-nums font-[family-name:var(--font-dm-sans)]">
                  {plan.price}
                </div>
              ...
              <Link
                ...
                className={`inline-flex items-center justify-center gap-[6px] px-[20px] py-[12px] text-[13px] font-[700] transition-colors font-[family-name:var(--font-dm-sans)] ${plan.popular ? "bg-[#0ea5a0] text-white hover:bg-[#0b7d79]" : "border border-[#1a1a2e] text-[#1a1a2e] hover:bg-[#1a1a2e] hover:text-white"}`}
              >
            ...
            {ARTICLES.map(a => {
              ...
              return (
                <article key={a.title} className="bg-white border border-[#E2E8F0] p-[22px] flex flex-col hover:border-[#0ea5a0] transition-colors">
                  ...
                  <h3 className="text-[17px] font-[700] text-[#1a1a2e] leading-[1.25] mb-[10px] font-[family-name:var(--font-dm-sans)]">
                    {a.title}
                  </h3>
                  ...
                  <span className="inline-flex items-center gap-[6px] text-[12px] font-[600] text-[#94A3B8] font-[family-name:var(--font-dm-sans)]">
                    <span className="h-[6px] w-[6px] bg-[#0ea5a0] rounded-full" /> Coming soon
                  </span>
                </article>
              )
            })}
