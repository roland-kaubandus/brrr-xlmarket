  ...
  return (
    <div className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[32px] sm:py-[48px]">
      <nav className="text-[12px] font-[family-name:var(--font-jakarta)] text-[#999999] mb-[32px]" aria-label="Leheasukoht">
        <Link href={`/${(await params).locale}`} className="hover:text-[#E8650A] transition-colors">Avaleht</Link>
        <span className="mx-[8px] text-[#E8E8E8]">/</span>
        <span className="text-[#777777]">Privaatsuspoliitika</span>
      </nav>

      <h1 className="text-[28px] sm:text-[32px] font-[700] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mb-[32px]">Privaatsuspoliitika</h1>

      <div className="max-w-[720px] text-[14px] font-[family-name:var(--font-jakarta)] text-[#555555] leading-relaxed space-y-[16px]">
        <p>Kehtib alates: 28.03.2026</p>

        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">1. Vastutav töötleja</h2>
        <p>
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">2. Milliseid isikuandmeid me kogume</h2>
        <p>Kogume tellimuse töötlemiseks vajalikke andmeid:</p>
        <ul className="list-disc pl-[20px] space-y-[6px] text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">3. Andmete kogumise eesmärk</h2>
        <ul className="list-disc pl-[20px] space-y-[6px] text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">4. Andmete säilitamine</h2>
        <p>
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">5. Andmete jagamine</h2>
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">6. Küpsised</h2>
        <p>
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">7. Teie õigused</h2>
        <p>Teil on õigus:</p>
        <ul className="list-disc pl-[20px] space-y-[6px] text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">
        ...
        <h2 className="text-[18px] font-[600] font-[family-name:var(--font-poppins)] text-[#1A1A1A] mt-[32px] mb-[12px]">8. Kontakt</h2>
        <p>
