...
export default async function TarnePage({ params }: { params: Promise<{ locale: string }> }) {
  return (
    <div className="max-w-[1280px] mx-auto px-[16px] sm:px-[24px] py-[32px] sm:py-[48px]">
      ...
      >
        <Link href={`/${(await params).locale}`} className="hover:text-[#E8650A] transition-colors">
          Avaleht
        </Link>
          ...
          {[
            ...
            <div key={title} className="flex items-start gap-[14px] p-[18px] border border-[#E8E8E8]">
              ...
              <div>
                ...
                <p className="text-[13px] text-[#777777] font-[family-name:var(--font-jakarta)]">
                  {desc}
                </p>
              </div>
            </div>
        ...
        <div className="mb-[40px]">
          ...
          <div className="border border-[#E8E8E8] overflow-hidden">
            ...
            <div className="grid grid-cols-3 px-[16px] py-[14px] border-b border-[#F0F0F0]">
              <span className="text-[14px] text-[#1A1A1A] font-[family-name:var(--font-jakarta)]">Standardtarne</span>
              <span className="text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">5–15 tööpäeva</span>
              <span className="text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">4,99 €</span>
            </div>
            <div className="grid grid-cols-3 px-[16px] py-[14px]">
              <span className="text-[14px] text-[#1A1A1A] font-[family-name:var(--font-jakarta)]">Alates 50 €</span>
              <span className="text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)]">5–15 tööpäeva</span>
              <span className="text-[14px] font-[600] text-[#2E7D32] font-[family-name:var(--font-jakarta)]">Tasuta</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-[24px]">
          {[
            ...
            <div key={section.title}>
              ...
              <p className="text-[14px] text-[#555555] font-[family-name:var(--font-jakarta)] leading-relaxed">
                {section.text}{" "}
                {section.link && (
