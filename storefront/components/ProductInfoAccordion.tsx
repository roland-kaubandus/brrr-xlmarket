  ...
  const items: AccordionItem[] = [
    {
      ...
      content: (
        <div className="flex flex-col gap-1.5">
          <p><strong className="text-[#1E293B]">Tasuta tarne</strong>{" tellimustel alates 50\u20AC."}</p>
          <p>{"Tarne aeg "}<strong className="text-[#1E293B]">{"5\u201315 t\u00F6\u00F6p\u00E4eva"}</strong>{" Eestisse."}</p>
          <p>{"Saadetakse DPD, Omniva v\u00F5i DHL kaudu. Pakiautomaati saatmine v\u00F5imalik."}</p>
          <p className="text-[#64748B] text-xs mt-1">{"Tellimused t\u00F6\u00F6deldakse 1\u20132 t\u00F6\u00F6p\u00E4eva jooksul."}</p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-1.5">
          <p><strong className="text-[#1E293B]">2-aastane garantii</strong>{" k\u00F5igile toodetele."}</p>
          <p>{"Garantii katab tootmisdefektid ja materjalivead. Ei kata mehhaanilisi kahjustusi ega v\u00E4\u00E4rkasutust."}</p>
          <p>{"Garantiin\u00F5ude esitamiseks v\u00F5tke \u00FChendust: "}<a href="mailto:info@xlmarket.eu" className="text-[#D97706] underline hover:text-[#B45309]">info@xlmarket.eu</a></p>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-1.5">
          <p><strong className="text-[#1E293B]">{"14 p\u00E4eva tagastus\u00F5igus"}</strong>{" alates kauba k\u00E4ttesaamisest."}</p>
    ...
    },
    {
      ...
      content: (
        <div className="flex flex-col gap-1.5">
          <p>{"Aktsepteerime: "}<strong className="text-[#1E293B]">{"pangakaart, pangalink, j\u00E4relmaks"}</strong>.</p>
