...
export default function ProductWishlistButton({ item, locale }: Props) {
  ...
  return (
    <button
      ...
      aria-label={label}
      className="w-full h-11 flex items-center justify-center gap-2 rounded-lg border border-[#E2E8F0] bg-white text-[13.5px] font-semibold text-[#1a1a2e] hover:border-[#0ea5a0] hover:text-[#0b7d79] transition-colors"
    >
