          ...
          <div className="flex gap-1.5 overflow-x-auto pb-0.5 scrollbar-hide">
            {images.slice(0, 8).map((img, i) => (
              <button
                ...
                type="button"
                onClick={() => setActive(i)}
                className={"relative shrink-0 w-[52px] h-[52px] bg-silver rounded-lg border-2 overflow-hidden transition-all duration-200 " + (i === active ? "border-[#0ea5a0]" : "border-transparent")}
              >
